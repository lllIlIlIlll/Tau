...
```bash
# 复制皮肤
cp -r ai-bubu-main/packages/app/public/skins/boy apps/pet/skins/
cp -r ai-bubu-main/packages/app/public/skins/dinosaur apps/pet/skins/
cp -r ai-bubu-main/packages/app/public/skins/line apps/pet/skins/
cp -r ai-bubu-main/packages/app/public/skins/mort apps/pet/skins/
cp -r ai-bubu-main/packages/app/public/skins/tard apps/pet/skins/
```

## 与 stapp.py 集成

在 `apps/web/streamlit/app.py` (原 stapp.py) 中点击"🐱 桌面宠物"按钮会自动启动桌面宠物，并在每个 turn 结束时发送通知。
