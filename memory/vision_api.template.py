...
CLAUDE_CONFIG_KEY = 'claude_config141'   # .tau/taukey.py 中 Claude 配置的变量名
OPENAI_CONFIG_KEY = 'oai_config1'        # .tau/taukey.py 中 OpenAI 配置的变量名
...
def _load_config():
    from core.llm.keys import reload_taukeys
    reload_taukeys()
    from core.llm import keys as _keys
    class _Mk:
        pass
    mk = _Mk()
    for k, v in _keys.taukeys.items():
        setattr(mk, k, v)
    return mk
