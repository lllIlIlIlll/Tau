...
echo -e "${CYAN}"
echo "╔═══════════════════════════════════════════════════════════╗"
echo "║   Tau — macOS Desktop App Installer             ║"
echo "╚═══════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
if [ "${AUTO_MODE}" = false ]; then
    echo ""
    echo "This will install a desktop app that launches Tau"
...
log_info "Applying Tau icon..."
if [ -f "${ICON_PATH}" ]; then
    ICONSET_DIR="${TMP_DIR}/tau-icon.iconset"
    mkdir -p "${ICONSET_DIR}"
    ...
    iconutil -c icns "${ICONSET_DIR}" -o "${TMP_DIR}/tau-icon.icns"
    cp "${TMP_DIR}/tau-icon.icns" "${TMP_DIR}/${APP_NAME}.app/Contents/Resources/applet.icns"
